...
@interface iTunesApplication : SBApplication <iTunesApplicationType>
...
@property (copy, readonly) id<iTunesTrackType> currentTrack;  // the current targeted track
...
@interface iTunesArtwork : iTunesItem <iTunesArtworkType>
...
@interface iTunesTrack : iTunesItem <iTunesTrackType>
